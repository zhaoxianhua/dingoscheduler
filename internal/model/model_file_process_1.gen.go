...
const TableNameModelFileProcess1 = "model_file_process_1"

// ModelFileProcess1 mapped from table <model_file_process_1>
type ModelFileProcess1 struct {
...
// TableName ModelFileProcess1's table name
func (*ModelFileProcess1) TableName() string {
	return TableNameModelFileProcess1
}
